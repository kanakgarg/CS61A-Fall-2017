...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if player == 0:
            num_turns = strategy0(score0, score1)
            score0 += take_turn(num_turns, score1, dice)
        else:
            num_turns = strategy1(score1, score0)
            score1 += take_turn(num_turns, score0, dice)
        score0, score1 = switch(score0, score1)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while(currRoll<11):
        ...
        avgPoints = make_averaged(roll_dice, num_samples)(currRoll, dice)
        if(avgPoints>make_averaged(roll_dice, num_samples)(reg,dice)):
            reg = currRoll
        currRoll+=1
    return reg
    # END PROBLEM 9
