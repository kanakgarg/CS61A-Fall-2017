    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                if self.ant.container and isinstance(self.ant.ant, QueenAnt):
                    if insect.value != 0:
                        self.ant.ant = None
                    else:
                        return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        """
        # BEGIN Problem 5
        min_r, max_r = self.min_range, self.max_range
        ...
        while min_r < max_r and (place is hive or place.bees == []):
            place = place.entrance
            min_r += self.increment
            if place == None:
                return None
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        ...
        if bee:
            ...
            self.time_till_digest += self.time_to_digest
    ...
    def action(self, colony):
        # BEGIN Problem 10
        if self.time_till_digest ==0:
            self.eat_bee(random_or_none(self.place.bees))
        elif self.time_till_digest>0:
            self.time_till_digest -=1
        # END Problem 10
...
# END Problem 13
    ...
    def __init__(self):
        # BEGIN Problem 13
        self.value = QueenAnt.counter
        QueenAnt.counter +=1
        self.ants_doubled = [None]
        Ant.__init__(self)
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.value != 0:
            ...
            place = self.place
            while place.exit:
                if place.exit.ant not in self.ants_doubled:
                    place.exit.ant.damage = place.exit.ant.damage * 2
                    self.ants_doubled += [place.exit.ant]
                if place.exit.ant and place.exit.ant.container and place.exit.ant.ant not in self.ants_doubled:
                    place.exit.ant.ant.damage = place.exit.ant.ant.damage *2
                    self.ants_doubled += [place.exit.ant.ant]
                place = place.exit
