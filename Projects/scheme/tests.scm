...
(define word (quote hello))
; expect word

word
; expect hello

(define another_word 'hello)
; expect another_word

another_word
; expect hello

(eq? word another_word)
; expect True
...
(define func (mu (var) (* var var2)))
; expect func

(define head_func (lambda (var var2) (func (/ var var))))
; expect head_func
